package com.hunayn.keuangan.model;
...
public class User {
    ...
    public JSONObject getUser() {
        ...
        if (cursor.moveToFirst()) {
            try {
                user_data.put("nama", cursor.getString(cursor.getColumnIndex("nama")));
                user_data.put("email", cursor.getString(cursor.getColumnIndex("email")));
                user_data.put("uang", cursor.getString(cursor.getColumnIndex("uang")));
                user_data.put("pendapatan", cursor.getString(cursor.getColumnIndex("pendapatan")));
                user_data.put("pengeluaran", cursor.getString(cursor.getColumnIndex("pengeluaran")));
